...
private:
    ...
    int thumb_format3(uint16_t opcode, Memory &mem);
    ...
    int thumb_format1(uint16_t opcode, Memory &mem);
    int thumb_format2(uint16_t opcode, Memory &mem);
    int thumb_format4(uint16_t opcode, Memory &mem);
    int thumb_format5(uint16_t opcode, Memory &mem);
};